    ...
    >
      <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-2xl shadow-2xl max-w-4xl w-full my-8 max-h-[90vh] overflow-y-auto border border-gray-200/50 dark:border-gray-700/50">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {operators.map((op) => (
                ...
                >
                  <code className="px-2 py-0.5 bg-gray-100/80 dark:bg-gray-700/80 backdrop-blur-sm text-film-orange-600 dark:text-film-orange-500 rounded-2xl font-mono shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
                    {op.op}
                  </code>
            ...
            <div key={category.category}>
              ...
              <div className="space-y-2">
                {category.items.map((item, idx) => (
                  ...
                  >
                    <code className="px-3 py-1 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-0 text-film-orange-600 dark:text-film-orange-500 rounded-2xl font-mono text-sm flex-shrink-0 shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
                      {item.query}
                    </code>
        ...
        <div className="sticky bottom-0 bg-white/40 dark:bg-gray-800/40 backdrop-blur-md border-t border-gray-200/60 dark:border-gray-700/60 px-6 py-4 rounded-b-2xl">
          <button
            onClick={onClose}
            className="w-full sm:w-auto px-6 py-2.5 sm:py-2 bg-film-orange-600 hover:bg-film-orange-700 backdrop-blur-sm text-white rounded-3xl font-medium transition-all duration-200 shadow-[0_4px_6px_rgba(0,0,0,0.1),inset_0_1px_0_rgba(255,255,255,0.2)] hover:shadow-[0_6px_8px_rgba(0,0,0,0.15),inset_0_1px_0_rgba(255,255,255,0.2)]"
          >
            Got it!
          </button>
        </div>
